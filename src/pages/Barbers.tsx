...
const barberData: Barber[] = [
  ...
  },
  {
    id: 5,
    name: "Jamal Wilson",
    image: "https://images.unsplash.com/photo-1504447910097-8ebaa0f82ece?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=774&q=80",
    location: "Cologne, Germany",
    rating: 4.6,
    reviewCount: 78,
  ...
  },
  {
    id: 6,
    name: "Priya Sharma",
    image: "https://images.unsplash.com/photo-1603585931234-a3b87ecc9fcd?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=774&q=80",
    location: "Berlin, Germany",
    rating: 4.8,
    reviewCount: 113,
...
const Barbers = () => {
  ...
  const barbersWithDistance = barberData.map(barber => {
    let distance = null;
          ...
          <div className="flex flex-col items-center justify-center py-6">
            {locationLoadingState === 'loading' && (
              <div className="flex flex-col items-center">
                <LucideLoader className="h-12 w-12 text-barber-primary animate-spin mb-4" />
